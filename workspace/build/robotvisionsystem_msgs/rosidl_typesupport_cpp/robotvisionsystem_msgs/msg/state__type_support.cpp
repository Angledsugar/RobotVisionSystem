...
static const _State_type_support_symbol_names_t _State_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotvisionsystem_msgs, msg, State)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotvisionsystem_msgs, msg, State)),
  }
};
...
{
  return &::robotvisionsystem_msgs::msg::rosidl_typesupport_cpp::State_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotvisionsystem_msgs, msg, State)() {
  return get_message_type_support_handle<robotvisionsystem_msgs::msg::State>();
}
