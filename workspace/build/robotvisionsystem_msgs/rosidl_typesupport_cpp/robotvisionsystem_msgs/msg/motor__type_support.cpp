...
static const _Motor_type_support_symbol_names_t _Motor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotvisionsystem_msgs, msg, Motor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotvisionsystem_msgs, msg, Motor)),
  }
};
...
{
  return &::robotvisionsystem_msgs::msg::rosidl_typesupport_cpp::Motor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotvisionsystem_msgs, msg, Motor)() {
  return get_message_type_support_handle<robotvisionsystem_msgs::msg::Motor>();
}
