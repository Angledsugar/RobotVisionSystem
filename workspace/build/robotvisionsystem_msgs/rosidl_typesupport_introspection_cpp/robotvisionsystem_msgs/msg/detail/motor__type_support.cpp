...
{
  new (message_memory) robotvisionsystem_msgs::msg::Motor(_init);
}

void Motor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robotvisionsystem_msgs::msg::Motor *>(message_memory);
  typed_message->~Motor();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Motor_message_member_array[3] = {
  {
    ...
    offsetof(robotvisionsystem_msgs::msg::Motor, steer),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robotvisionsystem_msgs::msg::Motor, motorspeed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robotvisionsystem_msgs::msg::Motor, breakbool),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Motor_message_members = {
  ...
  "Motor",  // message name
  3,  // number of fields
  sizeof(robotvisionsystem_msgs::msg::Motor),
...
{
  return &::robotvisionsystem_msgs::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotvisionsystem_msgs, msg, Motor)() {
  return &::robotvisionsystem_msgs::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}
